...
- **Use the test-runner agent** to run the success criteria checks (usually `cmake --build build --config Release` covers the build verification)
  - The test-runner agent will provide detailed results including full error messages if the build fails
