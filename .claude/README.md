...
2. Update the repository name in code-reviewer.md template to match the actual repo name (currently: "Saturator")
...
3. **Testing Framework**
   - This project uses CMake builds as the primary verification method
   - The test-runner agent is configured for CMake/MSVC builds (no pytest)
...
5. **Code Reviewer Agent Customization**
   ...
   - The current reviewer expects C++17/JUCE code matching this repository's conventions
